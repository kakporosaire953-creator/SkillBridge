      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-white border border-[#E2E8E5] rounded-3xl p-8 sm:p-12 shadow-xs space-y-8">
        ...
        <div className="space-y-6 text-xs sm:text-sm text-stone-700 font-light leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-heading font-bold text-base text-[#123B5D]">1. Protection et souveraineté des données</h2>
            <p>SkillBridge respecte la souveraineté numérique de ses utilisateurs. Les données de profil et les preuves de compétences ne sont partagées qu'avec votre accord explicite.</p>
          </section>

          <section className="space-y-2">
            <h2 className="font-heading font-bold text-base text-[#123B5D]">2. Utilisation du Skill Passport</h2>
            <p>Votre passeport numérique peut être partagé publiquement via votre lien personnel ou restreint aux organisations partenaires que vous autorisez.</p>
          </section>
        </div>
